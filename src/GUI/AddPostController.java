...
public class AddPostController implements Initializable {
    ...
    @FXML
     public boolean checkField(ActionEvent event) throws IOException{
         try{
            Alert alert;
            if (inputTitlePost.getText().isEmpty() || inputDescriptionPost.getText().isEmpty()) {
            ...
            return false;     
                ...
                String query = "INSERT INTO post (`dateCreationp`,`title`,`descriptionp`,`nbrecomment`) VALUES (NOW(),?,?,?)";
