...
public class Biblio extends Application {
    ...
    public void start(Stage primaryStage) throws IOException {
       ...
       // FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/AjoutDocuments.fxml")) ;
          //FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/supprimerdocuments_admin.fxml")) ;
          // FXMLLoader loader = new FXMLLoader(getClass().getResource("/GUI/mail.fxml")) ;
